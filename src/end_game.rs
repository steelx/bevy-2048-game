...
const NEIGHBOUR_TILES: [(i32, i32); 4] = [(-1, 0), (1, 0), (0, 1), (0, -1)];

fn has_game_ended(tiles: Query<(&TilePosition, &Tile)>, board_query: Query<&Board>) {
                ...
                NEIGHBOUR_TILES
                  ...
                  .filter_map(|(x1, y1)| {
                      ...
                      tiles_map.get(&TilePosition {
                          x: new_x.try_into().unwrap(), y: new_y.try_into().unwrap()
                      })
                  })
